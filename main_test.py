...
class Gui(GUI.Ui_MainWindow):
    ...
    def setup_ui_additional(self, MainWindow):
        ...
        # self.searchResultsTable.setSelectionBehavior(QAbstractItemView_SelectionBehavior=Select_Rows)
    ...
    def add_waveform_to_label(self):
        ...
        pixmap_resized = pixmap.scaled(self.waveform.width(), self.waveform.height(), QtCore.Qt.IgnoreAspectRatio)
        self.waveform.setPixmap(pixmap_resized)
...
class Window(QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        ui = Gui()
        ui.setupUi(self)
        ui.setup_ui_additional(self)
        self.resized.connect(self.resize_waveform)
