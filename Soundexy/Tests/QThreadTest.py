...
from Soundexy.Tests.QThreadTestTest import Worker
import time


class WorkerSignalsWrong(QObject):
    '''
...
class WorkerWrong(QRunnable):
    ...
    def __init__(self, fn, *args, **kwargs):
        super(WorkerWrong, self).__init__()

        # Store constructor arguments (re-used for processing)
        self.fn = fn
        self.args = args
        self.kwargs = kwargs
        self.signals = WorkerSignalsWrong()
